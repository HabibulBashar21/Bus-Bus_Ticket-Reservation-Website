    ...
    <div class="container-fluid bg">
        <div class="row">
            <div class="col-sm-4">
                ...
                <form>
                    ...
                    <div class="form-group">
                      ...
                      <button type="button" class="btn btn-primary" style="float:left;">Get Ticket Details</button>
            ...
            <div class="col-sm-8" style="border:1px solid #b8babc;padding:45px;">
                ...
                <br>
                <br>
                <div style="color:grey;text-align:center;font-size:15px;">If you have a confirmed ticket booked through www.Deshantor.com, please enter your ticket PNR and you can get it printed, SMSed or emailed from this panel.<br> In case you have reserved a ticket thorugh bKash and want to confirm your bKash
                    transaction ID to get your confirmed ticket, please enter your Reservation Reference ID.</div>
            </div>
